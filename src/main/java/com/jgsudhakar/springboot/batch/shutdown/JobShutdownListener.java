package com.jgsudhakar.springboot.batch.shutdown;
...
/*************************************
 * This Class is used to close this job with stopped status if it is running during the application / server shutdown initiated.
 * Author  : Sudhakar Tangellapalli
 * File    : com.jgsudhakar.springboot.batch.shutdown.JobShutdownListener
 * Date    : 18-08-2024
 * Version : 1.0
 **************************************/
@Component
...
public class JobShutdownListener implements ApplicationListener<ContextClosedEvent> {
    ...
    /**
     * Initializing the constructor to map the Object
     * */
    public JobShutdownListener(JobExplorer jobExplorer,JobOperator jobOperator,
     ...
     *
     * @param contextClosedEvent the event to respond to
     */
    @Override
    public void onApplicationEvent(ContextClosedEvent contextClosedEvent) {
        log.info("JobShutdownListener#onApplicationEvent . Shutdown initiated by system or someone. Checking any jobs running and shutting those jobs");
